...
public class CycleEntryTest {
    ...
    public void testGetDistance() {
        ...
        float result = instance.getCycleDistance();
        assertEquals(expResult, result);
    }
    ...
    public void testGetSurface() {
        ...
        String result = instance.getSurface();
        assertEquals(expResult, result);
    }
    ...
    public void testGetEntry() {
        ...
        CycleEntry instance = new CycleEntry("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "moderate");
        String expResult = "Alice cycled 3.0 km in 0:16:7 on 1/2/2003 on surface: asphalt at moderate kmph. \n";
